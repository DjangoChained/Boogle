...
public class StdUserInterface extends UserInterface {
    ...
    public void printHighScores() {
        ...
        if (players.size() > 0) {
            ...
            System.out.println("Aucun meilleur score pour l'instant...\n");
        }
    }
     ...
     *
     * @param players Liste de joueurs à afficher.
     * @param isHighScore Afficher sous le format d'une liste de meilleurs
     * scores.
     */
